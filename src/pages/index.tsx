...
export default function Home() {
  ...
  return (
    <>
      ...
      <header className={st.blockStylesForAppear} ref={mainRef}>
        <Header was={false} />
        <Main />
      </header>
      <Plane />
      <Particles />
      <main className={st.all} ref={allRef}>
        <section className={st.blockStylesForAppear} ref={aboutRef}>
          <About />
        </section>
        <section className={st.blockStylesForAppear} ref={skillsRef}>
          <Skills />
        </section>
        <section className={st.blockStylesForAppear} ref={portfolioRef}>
          <Portfolio />
        </section>
        <section className={st.blockStylesForAppear} ref={forYouRef}>
          <ForYou />
        </section>
        <section className={st.blockStylesForAppear} ref={contactsRef}>
          <Contacts />
        </section>
      </main>
      <PortfolioFull />
