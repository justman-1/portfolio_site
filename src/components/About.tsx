      ...
      <div className={st.aboutText}>
        ...
        <ul>
          ...
          <li className={st.textPoint}>
            ...
            фриланс-биржах(Kwork в частности) получил богатый опыт создания
            сайтов, которые вы можете увидеть в моем{" "}
            <span
              className={st.link}
              onClick={() => {
        ...
        <ul>
          ...
          <li className={st.textPoint}>
            ...
            применять алгоритмы и математику в программировании. Благодаря этому
            я создаю качественный оптимизированный продукт.
          </li>
        </ul>
