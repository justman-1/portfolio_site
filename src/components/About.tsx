    ...
    <>
      ...
      <div className={st.aboutText}>
        ...
        <li>
          ...
          по информатике. Данное соревнование сильно развило мои способности
          применения алгоритмов и математики в программировании. Это помогает
          мне создавать качественный продукт, который банально не тормозит.
        </li>
        <li>
