    ...
    <>
      ...
      <div className={st.aboutText}>
        <div>
          ...
          реализовать множество проектов, связанных с сайтами и JavaScript'ом в
          целом.
        </div>
        ...
        <li>
          ...
          по информатике, что сильно развило мои способности применения
          алгоритмов и математики в программировании, что помогает мне создавать
          качественный продукт, который банально не тормозит.
        </li>
        <li>
