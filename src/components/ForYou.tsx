    ...
    <>
      ...
      <div className={st.aboutText}>
        ...
        <div style={{ marginTop: "30px" }}>
          ...
          и на каком этапе разработки нахожусь в любой момент времени. Если
          будут иметься вопросы по проекту до начала нашей работы или в
          процессе, смело задавайте – на всё отвечу.
