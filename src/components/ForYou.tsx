  ...
  return (
    <>
      ...
      <div className={st.aboutText}>
        ...
        <div className={st.textPoint}>
          <strong style={{ color: "#a9c3ff" }}>Frontend-часть:</strong> создам
          клиентскую часть по предоставленному Вами дизайну.
        </div>
        <div className={st.textPoint}>
          <strong style={{ color: "#a9c3ff" }}>Backend-часть:</strong> создам
          серверную часть для вашего сайта.
        </div>{" "}
        <div style={{ marginTop: "30px" }}>
          Заранее обсудим все детали проекта, сроки, используемые технологии и
          стоимость, которые будут зависеть от масштаба и сложности проекта. Я
          же в свою очередь гарантирую то, что буду прозрачен, буду оповещать
          Вас о продвижении процесса разработки и регулярно показывать
          предварительный результат. Если будут иметься вопросы по проекту до
          начала нашей работы или в процессе, смело задавайте – на всё отвечу.
